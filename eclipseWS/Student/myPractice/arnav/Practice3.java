	...
	public static void main(String[] args) throws IOException {
		...
		if(n==0){
			...
			if((x+y)%2==0){
				...
				z = scanner.nextInt();
				if(z==1){
					System.out.println("Now you bat.");
					int total=0;
					x=y+1;
					while(x!=y){
						y = scanner.nextInt();
					...
					if(bob>=total){
						int youWin = 0;
						int cpuWin = 0;
						String youWinText = null;
						String cpuWinText = null;
						BufferedReader reader = null;
						File file = new File("/Users/Arnav/Documents/JrJavaMacNeon/eclipseWS/Arnav/src/Foo.txt");
						youWinText = reader.readLine();
						youWin=Integer.parseInt(youWinText);
						cpuWinText = reader.readLine();
						cpuWin=Integer.parseInt(cpuWinText);
						System.out.println("You lose!");
						System.out.println("Series score now is" + youWin + "-" + (cpuWin + 1));
						PrintWriter writer = new PrintWriter("/Users/Arnav/Documents/JrJavaMacNeon/eclipseWS/Arnav/src/Foo.txt");
						writer.println(youWin);
						writer.println(cpuWin + 1);
						writer.close();
					}
					else{
						int youWin = 0;
						...
						System.out.println("Series score now is" + (youWin+1) + "-" + cpuWin);
						PrintWriter writer = new PrintWriter("/Users/Arnav/Documents/JrJavaMacNeon/eclipseWS/Arnav/src/Foo.txt");
						writer.println(youWin + 1);
						writer.println(cpuWin);
						writer.close();
					}
					System.exit(0);
