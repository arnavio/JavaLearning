...
public class Practice5Optimized {
	...
	public static int play(Boolean youBat, int targetScore){
		...
		if (youBat)System.out.println("You are out! Your final score is "+ score );
		else System.out.println("CPU is out! CPU's final score is "+ score );
